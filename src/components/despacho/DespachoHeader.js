// ============================================
// DespachoHeader.js
// Header sticky del módulo de Despacho
// ============================================
import React from 'react';

const TABS = [
  { key: 'nuevo',   emoji: '🚚', label: 'Nuevo despacho' },
  { key: 'lista',   emoji: '📋', label: 'Despachos'      },
  { key: 'guias',   emoji: '📄', label: 'Guías'          },
];

export default function DespachoHeader({ mobile, tabActiva, setTabActiva, onVolver, onVolverMenu }) {
  const btnBase = {
