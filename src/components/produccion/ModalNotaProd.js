// ============================================
// ModalNotaProd.js
// Modal nota al admin desde producción
// ============================================
import React from 'react';

export default function ModalNotaProd({
  mobile,
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize:'12px', color:'#888', marginBottom:'10px' }}>
          Módulo: <strong>Producción</strong>
        </div>
        ...
        <textarea
          ...
          placeholder="Ej: La máquina de la salchicha se dañó, no pudimos completar las paradas..."
          rows={4}
          style={{
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              cursor: !textoNota.trim() ? 'not-allowed' : 'pointer',
              fontSize:'13px', fontWeight:'bold',
              opacity: !textoNota.trim() ? 0.7 : 1
            }}>
            ✉️ Enviar
          </button>
        </div>
